...
public class ClockWidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ConnectivityManager.CONNECTIVITY_ACTION.equals(action)) {
            ...
            // an event has been clicked on the widget
        } else if (ClockWidgetService.ACTION_CLICK_EVENT.equals(action)) {
            if (D) Log.v(TAG, "ACTION_CLICK_INTENT");
            Intent intentCalendar = new Intent(Intent.ACTION_MAIN).addCategory(Intent.CATEGORY_APP_CALENDAR);
