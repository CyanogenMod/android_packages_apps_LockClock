...
class CalendarRemoteViewsFactory implements RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        // TODO: Figure out how this works and if we need to set a intent on the item or the panel?
        ...
        fillInIntent.setData(Uri.parse("content://com.android.calendar/events/" + String.valueOf(event.id)));
