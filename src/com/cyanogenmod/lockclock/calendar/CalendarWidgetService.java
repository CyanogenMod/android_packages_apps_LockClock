...
class CalendarRemoteViewsFactory implements RemoteViewsFactory {
    ...
    private long calculateUpdateTime(Context context) {
        ...
        final boolean highlightNext = Preferences.calendarHighlightNextEntries(mContext);
        long lookAhead = Preferences.lookAheadTimeInMs(context);
        ...
        if (highlightNext) {
            ...
            if (startOfDay + TWENTY_HOURS_IN_MILLIS < minUpdateTime) {
                minUpdateTime = startOfDay + TWENTY_HOURS_IN_MILLIS;
