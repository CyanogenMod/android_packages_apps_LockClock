...
public class WeatherWidgetService extends IntentService {
    ...
    private void refreshWidget() {
        ...
        for (int id : mWidgetIds) {
            ...
            boolean smallWidget = WidgetUtils.showSmallWidget(this, id, 3, isKeyguard);
            if (smallWidget) {
    ...
    private void setWeatherData(RemoteViews weatherViews, boolean smallWidget, WeatherInfo w) {
        ...
        if (resId != 0) {
            weatherViews.setImageViewResource
                    (R.id.weather_image, w.getConditionResource(iconsSet));
        } else {
            weatherViews.setImageViewBitmap
                    (R.id.weather_image, w.getConditionBitmap(iconsSet, color));
        }
        ...
        if (!smallWidget) {
            ...
            weatherViews.setViewVisibility
                    (R.id.weather_city, showLocation ? View.VISIBLE : View.GONE);
            ...
            weatherViews.setTextViewText
                    (R.id.weather_low_high, invertLowhigh ? high + " | " + low :
                            low + " | " + high);
    ...
    private void setNoWeatherData(RemoteViews weatherViews, boolean smallWidget) {
        ...
        String noData = getString
                (R.string.weather_cannot_reach_provider, getString(providerNameResource));
        ...
        if (!smallWidget) {
            ...
            weatherViews.setTextViewText
                    (R.id.weather_refresh, getString(R.string.weather_tap_to_refresh));
            ...
            weatherViews.setViewVisibility
                    (R.id.weather_no_data, firstRun ? View.GONE : View.VISIBLE);
            weatherViews.setViewVisibility
                    (R.id.weather_refresh, firstRun ? View.GONE : View.VISIBLE);
        } else {
            weatherViews.setTextViewText(R.id.weather_temp, firstRun ? null : noData);
            weatherViews.setTextViewText
                    (R.id.weather_condition, firstRun ? null :
