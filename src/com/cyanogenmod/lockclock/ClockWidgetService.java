...
public class ClockWidgetService extends IntentService {
    ...
    private void refreshCalendar(RemoteViews calendarViews, int widgetId) {
        ...
        // TODO: get to work in the items
        // Bind a click listener template for the contents of the weather list.  Note that we
        // need to update the intent's data if we set an extra, since the extras will be
        // ignored otherwise.
        //final Intent i = new Intent(this, WeatherWidgetProvider.class);
        final Intent eventClickIntent = new Intent(Intent.ACTION_MAIN).addCategory(Intent.CATEGORY_APP_CALENDAR);
        eventClickIntent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, widgetId);
        eventClickIntent.setData(Uri.parse(eventClickIntent.toUri(Intent.URI_INTENT_SCHEME)));
