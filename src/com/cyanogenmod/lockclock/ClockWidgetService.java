...
public class ClockWidgetService extends IntentService {
    ...
    public static final String ACTION_CLICK_EVENT = "com.cyanogenmod.lockclock.action.CLICK_EVENT";
    ...
    private void refreshCalendar(RemoteViews calendarViews, int widgetId) {
        ...
        final Intent intent = new Intent(context, CalendarWidgetService.class);
        ...
        // Bind an onClickListener template on entries
        //final Intent i = new Intent(Intent.ACTION_MAIN).addCategory(Intent.CATEGORY_APP_CALENDAR);
        final Intent i = new Intent(context, ClockWidgetProvider.class);
        i.setAction(ClockWidgetService.ACTION_CLICK_EVENT);
