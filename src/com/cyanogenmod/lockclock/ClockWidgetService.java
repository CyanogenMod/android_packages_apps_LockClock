...
public class ClockWidgetService extends IntentService {
    ...
    private void refreshCalendar(RemoteViews calendarViews, int widgetId) {
        ...
        final Intent intent = new Intent(this, CalendarWidgetService.class);
        intent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, widgetId);
        intent.setData(Uri.parse(intent.toUri(Intent.URI_INTENT_SCHEME)));
        calendarViews.setRemoteAdapter(R.id.calendar_list, intent);
        calendarViews.setEmptyView(R.id.calendar_list, R.id.calendar_empty_view);

        /* TODO: This is the old intent stuff - it no longer works since this is now a framelayout
        ...
        PendingIntent pi = PendingIntent.getActivity(this, 0, i, PendingIntent.FLAG_UPDATE_CURRENT);
        calendarViews.setOnClickPendingIntent(R.id.calendar_icon, pi);
        */
    }
